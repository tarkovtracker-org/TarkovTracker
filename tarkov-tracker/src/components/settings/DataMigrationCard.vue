    ...
    <template #content>
        ...
        <v-card-text>
          ...
          <div class="migration-steps mb-4">
            ...
            <div class="step-item">
              ...
              <span class="step-text"
                >Login if you're not already logged in</span
              >
            </div>
            <div class="step-item">
            ...
            <div class="step-item">
              ...
              <span class="step-text"
                >Create a new token with "Get Progression" permission
                enabled</span
              >
            </div>
            <div class="step-item">
      ...
      <v-dialog v-model="confirmDialog" max-width="700">
        <v-card>
          <v-card-title class="text-h5 px-4 py-3"
            >Confirm Data Import</v-card-title
          >
                ...
                <v-card variant="outlined" class="mb-4 pa-1">
                  ...
                  <v-list density="compact" class="px-2">
                    <v-list-item>
                      ...
                      <v-list-item-title
                        >Level:
                        {{ importedData?.level || "N/A" }}</v-list-item-title
                      >
                    </v-list-item>
                    <v-list-item>
                      <template v-slot:prepend>
                ...
                <v-card variant="outlined" class="pa-1">
                  ...
                  <v-list density="compact" class="px-2">
                    <v-list-item>
                      ...
                      <v-list-item-title
                        >Completed Modules:
                        {{ countHideoutModules }}</v-list-item-title
                      >
                    </v-list-item>
                    <v-list-item>
                      <template v-slot:prepend>
                      ...
                      <v-list-item-title
                        >Tracked Materials:
                        {{ countHideoutParts }}</v-list-item-title
                      >
                    </v-list-item>
                  </v-list>
                </v-card>
      ...
      <v-dialog v-model="showObjectivesDetails" max-width="500">
        <v-card>
          ...
          <v-card-text>
            <p>
              The count of {{ countTaskObjectives }} task objectives represents
              all objective data in your import.
            </p>
            <p class="mt-3">
          ...
          <v-card-actions>
            ...
            <v-btn
              color="primary"
              variant="flat"
              @click="showObjectivesDetails = false"
              >Close</v-btn
            >
          </v-card-actions>
        </v-card>
        ...
        <v-card>
          ...
          <v-card-actions>
            ...
            <v-btn
              color="primary"
              variant="flat"
              @click="showFailedTaskDetails = false"
              >Close</v-btn
            >
          </v-card-actions>
        </v-card>
