...
> details live in `API.md`; rate-limit ownership lives in `RATE_LIMITING.md`; plain-language system
> specs (caching, data fetching, overlay, precompute) live in `SYSTEMS.md`. Other documents link to
