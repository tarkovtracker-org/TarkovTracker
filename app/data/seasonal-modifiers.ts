...
export const seasonalModifiers: SeasonalModifier[] = [
  ...
  },
  {
    ...
    type: 'positive',
    points: -3,
    description: 'Energy is consumed 20% slower. Arm and leg stamina is increased by 10.',
  },
  {
    id: 'street_tax',
    name: 'Street Tax',
  ...
  {
    id: 'the_tarkov_shooter',
    name: 'The Tarkov Shooter',
    type: 'positive',
    points: -3,
    description:
      'Bolt-action Rifles skill leveling speed is increased by 100%. Bolt-action Rifles skill starts at level 10.',
  },
  {
    id: 'diet',
    name: 'Diet',
  ...
  },
  {
    ...
    type: 'negative',
    points: 4,
    description: 'Arm and leg stamina recovers 15% slower. Arm and leg stamina is reduced by 10.',
  },
  {
    id: 'well_that_hurt',
    name: 'Well That Hurt!',
  ...
  },
  {
    ...
    points: 4,
    description:
      'All character skills are leveled 25% slower (Excluding Bolt-action Rifles). All character skills can only be increased up to level 30 (Excluding Crafting).',
  },
  {
    id: 'polydipsia',
    name: 'Polydipsia',
  ...
  {
    id: 'personality_vacuum',
    name: 'Personality Vacuum',
    type: 'negative',
    points: 2,
    description: 'Charisma skill cannot be increased. All trader items cost 20% more.',
  },
  {
    id: 'dr_jekyll',
    name: 'Dr. Jekyll',
  ...
  },
  {
    ...
    type: 'negative',
    points: 1,
    description: 'Movement speed is decreased by 1%. Buying items at Therapist is 5% cheaper.',
  },
] satisfies SeasonalModifier[];
