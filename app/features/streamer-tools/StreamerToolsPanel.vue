<template>
  <div class="space-y-4">
    <GenericCard
      ...
      :fill-height="false"
      :title="t('common.streamer_tools', 'Streamer Tools')"
    ...
    >
      ...
      <template #content>
        <p class="text-surface-300 px-4 py-4 text-sm">
          {{
            t(
          ...
          <details open class="p-4">
            ...
            <div class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <article v-if="!isSelfContained" class="space-y-2">
                ...
                <SelectMenuFixed v-model="selectedAlign" :items="alignOptions" value-key="value" />
              </article>
              ...
              <article class="space-y-2">
                ...
                <SelectMenuFixed v-model="intervalMs" :items="intervalOptions" value-key="value" />
              </article>
              <article class="space-y-2">
                <p class="text-surface-300 text-xs font-semibold tracking-wider uppercase">
              ...
              <article class="space-y-2 sm:col-span-2 lg:col-span-3">
                ...
                <UInput
                  v-model="customLabel"
                  :placeholder="
                    t('streamer_tools.custom_label_placeholder', 'Optional title for your overlay')
                  "
                  :maxlength="60"
                />
              </article>
              ...
              <article class="space-y-4 sm:col-span-2 lg:col-span-3">
                ...
                <div class="border-surface-700 space-y-4 rounded-lg border p-3">
                  ...
                  <div class="grid gap-4 sm:grid-cols-2">
                    <div class="space-y-1">
                      <label :for="cardColorId" class="text-surface-200 block text-xs font-medium">
                ...
                <div class="border-surface-700 space-y-4 rounded-lg border p-3">
                  ...
                  <div class="grid gap-4 sm:grid-cols-2">
                    <div class="space-y-1">
                      <label :for="trackColorId" class="text-surface-200 block text-xs font-medium">
                        {{ t('common.progress_track', 'Progress Track') }}
                      </label>
                      <input
                        :id="trackColorId"
