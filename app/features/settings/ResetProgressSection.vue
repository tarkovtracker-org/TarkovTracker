  ...
  <div class="space-y-5">
    <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
      <UButton
        ...
        block
        :ui="{
          base: 'bg-pvp-900 light:bg-pvp-50 hover:bg-pvp-800 light:hover:bg-pvp-100 active:bg-pvp-700 light:active:bg-pvp-100 text-pvp-200 focus-visible:ring focus-visible:ring-pvp-500 light:focus-visible:ring-pvp-700',
        }"
      ...
      <UButton
        ...
        block
        :ui="{
          base: 'bg-pve-900 light:bg-pve-50 hover:bg-pve-800 light:hover:bg-pve-100 active:bg-pve-700 light:active:bg-pve-100 text-pve-200 focus-visible:ring focus-visible:ring-pve-500 light:focus-visible:ring-pve-700',
        }"
