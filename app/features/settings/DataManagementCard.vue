      ...
      <div class="space-y-6 px-4 py-4">
        ...
        <div class="space-y-3">
                ...
                <li>
                  <span class="inline-flex items-center gap-1">
                    ...
                    <UTooltip :text="$t('settings.log_import.deleted_logs_hint_tooltip')">
                      <UIcon name="i-mdi-information" class="text-foreground-subtle h-3.5 w-3.5" />
                    </UTooltip>
                  </span>
                </li>
              </ul>
          ...
          <template v-if="backupImportState === 'preview' && backupPreview">
            <div class="bg-shell divide-border border-border divide-y rounded-md border">
          ...
          <template v-if="eftLogsImportState === 'preview' && eftLogsPreview">
            ...
            <div class="bg-shell divide-border border-border divide-y rounded-md border">
              ...
              <div class="flex items-center justify-between px-3 py-2">
                <span class="text-foreground-muted inline-flex items-center gap-1 text-xs">
            ...
            <div v-if="eftLogsUnknownCount > 0" class="space-y-1">
              ...
              <div class="bg-shell border-border rounded-md border px-3 py-2">
                <div v-if="eftLogsUnknownCompletedTaskIds.length > 0" class="mb-2 last:mb-0">
                  <p class="text-foreground-muted mb-1 text-xs">
                    {{ $t('settings.log_import.unknown_completion_events') }}
                  </p>
                  <ul class="text-foreground space-y-1 text-xs">
                    <li
            ...
            <p v-else class="text-foreground-muted text-xs">
