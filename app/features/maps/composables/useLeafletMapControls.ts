...
export const MAP_BUTTON_ACTIVE_CLASS =
  '!bg-[color-mix(in_srgb,var(--color-primary-500)_16%,var(--color-panel))] !text-foreground !ring-1 !ring-border';
export const MAP_BUTTON_INACTIVE_CLASS = 'text-foreground-muted hover:text-foreground';
