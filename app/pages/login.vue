<template>
  <div class="bg-military-background flex min-h-0 flex-1 items-center justify-center px-4 py-8">
    <UCard
      class="border-border bg-panel text-foreground shadow-elevated ring-border w-full max-w-md border ring-1"
      :ui="{
        root: 'divide-y-0',
        body: 'p-0 sm:p-0',
        header: 'p-0 sm:px-0',
    ...
    >
      ...
      <div class="px-8 pb-8">
        ...
        <div class="w-full space-y-6">
          <UButton
            ...
            class="hover:bg-twitch-hover hover:shadow-twitch/25 border-border/30 flex h-12 w-full items-center justify-center text-white ring-1 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
          ...
          <UButton
            ...
            class="hover:bg-discord-hover hover:shadow-discord/25 border-border/30 flex h-12 w-full items-center justify-center text-white ring-1 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
          ...
          <UButton
            ...
            size="xl"
            variant="solid"
            class="bg-panel border-border text-foreground hover:bg-raised shadow-card flex h-12 w-full items-center justify-center border transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
          ...
          <UButton
            ...
            class="hover:bg-github-hover hover:shadow-github/25 border-border/30 flex h-12 w-full items-center justify-center text-white ring-1 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
      ...
      <template #footer>
        <div class="border-border bg-raised/45 w-full border-t">
