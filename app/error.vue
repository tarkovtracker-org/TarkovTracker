<template>
  ...
  >
    <div class="bg-panel border-border shadow-card w-full max-w-2xl rounded-2xl border px-6 py-8">
      ...
      <div
        ...
        class="bg-shell border-border mt-5 rounded-xl border p-4 text-left"
      >
        ...
        <pre
          class="text-foreground-muted max-h-80 overflow-auto text-xs break-all whitespace-pre-wrap"
